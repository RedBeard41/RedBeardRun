...
public class EntityManager {
    private RedBeardRun redBeardRun;
    private World world;
    ...
    public EntityManager(RedBeardRun redBeardRun, World world, SpriteBatch batch, PooledEngine engine) {
    this.redBeardRun = redBeardRun;
    this.world = world;
    this.batch = batch;
    this.engine = engine;
